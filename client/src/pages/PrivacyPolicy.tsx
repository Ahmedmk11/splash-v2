                ...
                <ul>
                    ...
                    <li>
                        <p>
                            ...
                            refers to Splash, Tawfik Ahmed El-Bakry, Al Manteqah
                            as Sadesah, Nasr City, Cairo Governorate 4450473.
                        </p>
                    </li>
                    <li>
                        <p>
                    ...
                    <li>
                        <p>
                            <strong>Website</strong> refers to Splash,
                            accessible from{' '}
                            <a
                                href="https://www.splash-furniture.com"
                                rel="external nofollow noopener"
                                target="_blank"
                            >
                                https://www.splash-furniture.com
                            </a>
                        </p>
                    </li>
                    <li>
                ...
                <ul>
                    <li>
                        ...
                        <Link
                            ...
                            target="_blank"
                        >
                            https://www.splash-furniture.com/contact
                        </Link>
                    </li>
                </ul>
            </div>
